...
const profilePictureUrl = computed(() => {
  return profilePicture.value ? `data:image/jpeg;base64,${profilePicture.value}` : '';
});
  ...
  if (file) {
    ...
    reader.onload = (e) => {
      ...
      if (typeof result === 'string') {
        // Remueve el prefijo "data:image/*;base64," antes de asignar la imagen
        profilePicture.value = result.split(',')[1];
      }
    };
